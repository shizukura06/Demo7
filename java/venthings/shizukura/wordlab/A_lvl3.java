...
public class A_lvl3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO
        word = new String[]{"P","H","Y","S","I","C","A","L"};
        imageButton = (Button)findViewById(R.id.imageButton);
        //TODO
        imageButton.setText("Study of the structure of matter, energy, changes, laws, principles and theories.");
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl3.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl3.this);
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    switch (hintlvl) {
                                        ...
                                        case 8:
                                            ...
                                            buttons[lad].setText("");
                                            lagy.setText("PHYSICAL");
                                            break;
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl3.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO
                if(Objects.equals(lagy.getText().toString(), "PHYSICAL")){
                    Toast.makeText(A_lvl3.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        //TODO
                        if(level ==3){
                            dbEdit.putInt("level",4);
                        ...
                        dbEdit.putInt("current",3);
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl3.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl3.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl3.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
