...
public class A_lvl11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO
        word = new String[]{"W", "E", "I", "G", "H", "T"//,"M","Q","N","L"};
        };
        imageButton = (Button)findViewById(R.id.imageButton);
        //TODO
        imageButton.setText("The measure of the pull of gravity upon an object because of the object's mass.");
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl11.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl11.this);
                    builder.setMessage("Use hint? Cost 25 Substances")
                       ...
                       /*                case 7:
                                        ...
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl11.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO
                if(Objects.equals(lagy.getText().toString(), "WEIGHT")){
                    Toast.makeText(A_lvl11.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        //TODO
                        if(level ==11){
                            dbEdit.putInt("level",12);
                        ...
                        dbEdit.putInt("current",11);
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl11.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl11.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void scramble(){
        try {
            ...
            e1 = (int) (10 * random());
            while (e1 >= 6 || e1 == q || e1 == w)
            {
                e1 = (int) (10 * random());
            }

            r = (int) (10 * random());
            while (r >= 6 || r == q || r == w || r == e1)
            {
                r = (int) (10 * random());
            }

            t = (int) (10 * random());
            while (t >= 6 || t == q || t == w || t == r || t == e1){
                t = (int) (10 * random());
            }

            y = (int) (10 * random());
            while (y >= 6 || y == q || y == w || y == r || y == e1 || y == t){
                y = (int) (10 * random());
            }
       /*     u = (int) (10 * random());
            while (u >= 6 || u == q || u == w || u == r || u == e1 || u == t || u == y){
                u = (int) (10 * random());
            }

            i = (int) (10 * random());
            while (i >= 6 || i == q || i == w || i == r || i == e1 || i == t || i == y || i == u){
                i = (int) (10 * random());
            }

            o = (int) (10 * random());
            while (o >= 6 || o == q || o == w || o == r || o == e1 || o == t || o == y || o == u || o == i){
                o = (int) (10 * random());
            }

            p = (int) (10 * random());
            while (p >= 6 || p == q || p == w || p == r || p == e1 || p == t || p == y || p == u || p == o || p == i){
                p = (int) (10 * random());
            }
       */     lagy.setText("");
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl11.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
