...
public class A_lvl12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        word = new String[]{"I","N","T","E","N","S","I","V","E"};
        imageButton = (Button)findViewById(R.id.imageButton);
        imageButton.setText("Properties that depend in the quality or kind of matter.");
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl12.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl12.this);
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    switch (hintlvl) {
                                        ...
                                        case 8:
                                            ...
                                            buttons[lad].setText("");
                                            lad = 0;
                                            while(buttons[lad].getText() != "V"){
                                                lad++;
                                            }
                                            buttons[lad].setText("");
                                            lagy.setText("INTENSIV");
                                            break;
                                        case 9:
                                            ...
                                            buttons[lad].setText("");
                                            lagy.setText("INTENSIVE");
                                            break;
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl12.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Objects.equals(lagy.getText().toString(), "INTENSIVE")){
                    Toast.makeText(A_lvl12.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        if(level ==12){
                            dbEdit.putInt("level",13);
                        ...
                        dbEdit.putInt("current",12);
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl12.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl12.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl12.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
