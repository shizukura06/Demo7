            ...
            public class A_lvl8 extends AppCompatActivity {
                ...
                protected void onCreate(Bundle savedInstanceState) {
                    ...
                    //TODO
                    word = new String[]{"M", "A", "T", "T", "E", "R"//,"M","T","N","M"};
                    };
                    imageButton = (Button)findViewById(R.id.imageButton);
                    //TODO
                    imageButton.setText("Anything that occupies space and has mass.");
                    ...
                    hint.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (substance < 25) {
                                Toast.makeText(A_lvl8.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                            } else {
                                AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl8.this);
                                builder.setMessage("Use hint? Cost 25 Substances")
                                   ...
                                   /*                case 7:
                                                    ...
                                                    default:
                                                        scramble();
                                                        Toast.makeText(A_lvl8.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        })
                    ...
                    umbit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            //TODO
                            if(Objects.equals(lagy.getText().toString(), "MATTER")){
                                Toast.makeText(A_lvl8.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                                scramble();
                                try {
                                    dbEdit = getSharedPreferences("DB",0).edit();
                                    //TODO
                                    if(level ==8){
                                        dbEdit.putInt("level",9);
                                    ...
                                    dbEdit.putInt("current",8);
                                    dbEdit.apply();
                                    Intent intent = new Intent(A_lvl8.this,dialog.class);
                                ...
                                Toast.makeText(A_lvl8.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                                scramble();
                            }
                        }
                    });
                ...
                public void onBackPressed() {
                    if(hintlvl != 0){
                        ...
                        builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        Intent c = new Intent(A_lvl8.this, started.class);
                                        startActivity(c);
                                        finish();
                                    }
                                })
