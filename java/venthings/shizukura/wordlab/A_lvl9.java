...
public class A_lvl9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO
        word = new String[]{"L", "I", "Q", "U", "I", "D"//,"M","Q","N","L"};
        };
        imageButton = (Button)findViewById(R.id.imageButton);
        //TODO
        imageButton.setText("A thoroughly tested model that explains why experiments give certain result.");
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl9.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl9.this);
                    builder.setMessage("Use hint? Cost 25 Substances")
                       ...
                       /*                case 7:
                                        ...
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl9.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO
                if(Objects.equals(lagy.getText().toString(), "LIQUID")){
                    Toast.makeText(A_lvl9.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        //TODO
                        if(level ==9){
                            dbEdit.putInt("level",10);
                        ...
                        dbEdit.putInt("current",9);
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl9.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl9.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl9.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
