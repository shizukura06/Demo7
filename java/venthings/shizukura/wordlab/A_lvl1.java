...
public class A_lvl1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl1.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl1.this);
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    switch (hintlvl) {
                                        ...
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl1.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
            ...
            public void onClick(View v) {
                if(Objects.equals(lagy.getText().toString(), "CHEMISTRY")){
                    ...
                    try {
                        ...
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl1.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl1.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl1.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
