...
public class A_lvl14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        word = new String[]{"C","H","E","M","I","S","T","R","Y"};
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl14.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl14.this);
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    switch (hintlvl) {
                                        ...
                                        case 9:
                                            ...
                                            buttons[lad].setText("");
                                            lagy.setText("CHEMISTRY");
                                            break;
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl14.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Objects.equals(lagy.getText().toString(), "CHEMISTRY")){
                    Toast.makeText(A_lvl14.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        if(level ==1){
                            dbEdit.putInt("level",2);
                        ...
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl14.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl14.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl14.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
