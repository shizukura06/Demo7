...
public class A_lvl2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO
        word = new String[]{"A","N","A","L","Y","T","I","C","A","L"};
        imageButton = (Button)findViewById(R.id.imageButton);
        //TODO
        imageButton.setText("Branch of chemistry which concerns to the study of identification, separation and quantitative determination of the composition of different substance.");
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl2.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl2.this);
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    switch (hintlvl) {
                                        ...
                                        case 10:
                                            ...
                                            buttons[lad].setText("");
                                            lagy.setText("ANALYTICAL");
                                            break;
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl2.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO
                if(Objects.equals(lagy.getText().toString(), "ANALYTICAL")){
                    Toast.makeText(A_lvl2.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        //TODO
                        if(level ==2){
                            dbEdit.putInt("level",3);
                        ...
                        dbEdit.putInt("current",2);
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl2.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl2.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl2.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
