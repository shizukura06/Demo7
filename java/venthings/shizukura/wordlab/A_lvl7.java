...
public class A_lvl7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        word = new String[]{"F","R","E","E","Z","I","N","G"};
        imageButton = (Button)findViewById(R.id.imageButton);
        imageButton.setText("A _______ point is the temperature at which a liquid change to solid.");
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (substance < 25) {
                    Toast.makeText(A_lvl7.this, "Not enough substance to make a compound and form into a letter.", Toast.LENGTH_SHORT).show();
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(A_lvl7.this);
                                ...
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    switch (hintlvl) {
                                        ...
                                        case 8:
                                            ...
                                            buttons[lad].setText("");
                                            lagy.setText("FREEZING");
                                            break;
                                        default:
                                            scramble();
                                            Toast.makeText(A_lvl7.this, "All hints are used!", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
        ...
        umbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //TODO
                if(Objects.equals(lagy.getText().toString(), "FREEZING")){
                    Toast.makeText(A_lvl7.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                    try {
                        dbEdit = getSharedPreferences("DB",0).edit();
                        //TODO
                        if(level ==7){
                            dbEdit.putInt("level",8);
                        ...
                        dbEdit.putInt("current",7);
                        dbEdit.apply();
                        Intent intent = new Intent(A_lvl7.this,dialog.class);
                    ...
                    Toast.makeText(A_lvl7.this, "Wrong Answer!", Toast.LENGTH_SHORT).show();
                    scramble();
                }
            }
        });
    ...
    public void onBackPressed() {
        if(hintlvl != 0){
            ...
            builder.setMessage("If you quit now, the hint/s you've used will be discarded. Continue?")
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Intent c = new Intent(A_lvl7.this, started.class);
                            startActivity(c);
                            finish();
                        }
                    })
